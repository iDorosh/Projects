...
internal class ConfirmViewController: UIViewController, UIScrollViewDelegate {
    ...
    private func buttonActions() {
        confirmButton.addTarget(self, action: #selector(ConfirmViewController.confirmPhoto), for: UIControlEvents.touchUpInside)
        cancelButton.addTarget(self, action: #selector(ConfirmViewController.cancel), for: UIControlEvents.touchUpInside)
    }
