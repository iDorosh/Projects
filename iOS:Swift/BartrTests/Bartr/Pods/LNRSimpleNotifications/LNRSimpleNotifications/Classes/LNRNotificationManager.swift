...
public class LNRNotificationManager: NSObject {
     ...
     */
    public func showNotification(_ title: String, body: String?, onTap: LNRNotificationOperationCompletionBlock?) {
     ...
     */
    public func dismissActiveNotification(_ completion: LNRNotificationOperationCompletionBlock?) -> Bool {
     ...
     */
    public func dismissNotification(_ notification: LNRNotificationView, dismissAnimationCompletion:LNRNotificationOperationCompletionBlock?) -> Bool {
    ...
    */
    ...
    private func displayNotification(_ notification: LNRNotificationView) {
        ...
        UIView.animate(withDuration: kLNRNotificationAnimationDuration + 0.1, delay: 0, usingSpringWithDamping: 0.8, initialSpringVelocity: 0, options: [UIViewAnimationOptions.curveEaseInOut, UIViewAnimationOptions.beginFromCurrentState, UIViewAnimationOptions.allowUserInteraction], animations: { () -> Void in
