...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tx = (TextView)findViewById(R.id.loginText);
    ...
    //Creating a new user if one doesnt exist or loging in the user
    ...
    //Will loging the user based on the username and password
